...
|-----------------------|-------|-----------------------|---------|
| **Seakha Proxy + UI** | 8081  | http://localhost:8081 | Transparent Proxy + **NEW: Chat UI with memory** |
| Sekha Controller API  | 8080  | http://localhost:8080 | Core backend APIs |
| Sekha Bridge          | 5001  | http://localhost:5001 | LLM routing |
| ChromaDB              | 8000  | http://localhost:8000 | Vector database |
| Redis                 | 6379  | localhost:6379        | Cache layer |
| ollama                | 11434 |                       | Locall LLM |
